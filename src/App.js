...

                {
                    error ? (
                        ...
                        <Fragment>
                            ...
                            {/* DO NOT REMOVE/MODIFY THE FOOTER. FOR MORE INFO https://github.com/0x1381/info#-please-read */}
                            <footer className="p-4 footer bg-base-200 text-base-content footer-center">
                                <div>
                                    <p className="font-mono text-sm">Made with <a className="text-primary" href="https://github.com/armusalone/" target="_blank" rel="noreferrer">Alone for ever</a></p>
                                </div>
                            </footer>
                        </Fragment>
                    )
